...
async function processAnalysisInBackground(userId, forceRefresh = false) {
    try {
      ...
      `);
        if (error)
            throw error;
        console.log(`Fetched ${(data === null || data === void 0 ? void 0 : data.length) || 0} pain points`);
        ...
        const painPointsContext = data.map(pp => {
            ...
            return {
                ...
                impact: pp.impact,
                company: ((_a = meeting === null || meeting === void 0 ? void 0 : meeting.companies) === null || _a === void 0 ? void 0 : _a.name) || 'Unknown',
                industry: ((_b = meeting === null || meeting === void 0 ? void 0 : meeting.companies) === null || _b === void 0 ? void 0 : _b.industry) || 'Unknown',
                contact: ((_c = meeting === null || meeting === void 0 ? void 0 : meeting.contacts) === null || _c === void 0 ? void 0 : _c.name) || 'Unknown',
            };
        });
        ...
        const painPointsMap = data.reduce((acc, pp) => {
            acc[pp.id] = pp;
            return acc;
        }, {});
 ...
 */
async function storePainPointClusters(clusters) {
    try {
...
async function analyzeCommonPainPoints(painPoints, apiKey) {
...
`
        ...
        try {
            ...
            if (structuredJsonResponse && typeof structuredJsonResponse === 'object') {
                if (structuredJsonResponse.output_text) {
                    try {
                        const parsedData = JSON.parse(structuredJsonResponse.output_text);
                ...
                else if ((_h = (_g = (_f = (_e = structuredJsonResponse.output) === null || _e === void 0 ? void 0 : _e[0]) === null || _f === void 0 ? void 0 : _f.content) === null || _g === void 0 ? void 0 : _g[0]) === null || _h === void 0 ? void 0 : _h.text) {
                    try {
